...
import { useToolCache } from "../composables/useToolCache.js";
import type { CachedToolEntry as Entry, CacheClient } from "../client.js";

const props = defineProps<{ client: CacheClient }>();
