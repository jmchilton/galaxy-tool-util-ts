// Generated by make sync-user-tool-source-schema. Do not edit.
// Source of truth: galaxy.tool_util_models.DynamicToolSources (see schema.json).
export const userToolSourceSchema = {
  $defs: {
    Citation: {
      properties: {
        content: {
    ...
    EmptyFieldParameterValidatorModel: {
      ...
      title: "EmptyFieldParameterValidatorModel",
      type: "object",
    },
    FilePatternDatasetCollectionDescription: {
      properties: {
        assign_primary_output: {
          title: "Assign Primary Output",
          type: "boolean",
        },
        directory: {
          anyOf: [
        ...
        sort_comp: {
          enum: ["lexical", "numeric"],
          title: "Sort Comp",
          type: "string",
        },
        sort_key: {
          enum: ["filename", "name", "designation", "dbkey"],
          title: "Sort Key",
          type: "string",
        },
        sort_reverse: {
      ...
      title: "FilePatternDatasetCollectionDescription",
      type: "object",
    },
    HelpContent: {
      properties: {
        ...
        format: {
          enum: ["restructuredtext", "plain_text", "markdown"],
          title: "Format",
          type: "string",
        },
      },
    ...
    InRangeParameterValidatorModel: {
      ...
      title: "InRangeParameterValidatorModel",
      type: "object",
    },
    IncomingToolOutputCollection: {
      properties: {
        ...
        structure: {
          $ref: "#/$defs/ToolOutputCollectionStructure",
        },
        type: {
          const: "collection",
          title: "Type",
      ...
      title: "IncomingToolOutputCollection",
      type: "object",
    },
    IncomingToolOutputDataset: {
          ...
          anyOf: [
            {
              items: {
                anyOf: [
                  {
                    $ref: "#/$defs/FilePatternDatasetCollectionDescription",
                  },
                  {
      ...
      required: ["type"],
      title: "IncomingToolOutputDataset",
      type: "object",
    },
    JavascriptRequirement: {
          ...
          anyOf: [
            {
              items: {
                description:
                  "Provide Javascript/ECMAScript 5.1 code here that will be available for expressions inside the `shell_command` field.",
                examples: [
      ...
      required: ["type", "expression_lib"],
      title: "JavascriptRequirement",
      type: "object",
    },
    LengthParameterValidatorModel: {
      ...
      title: "LengthParameterValidatorModel",
      type: "object",
    },
    NoOptionsParameterValidatorModel: {
      ...
      title: "NoOptionsParameterValidatorModel",
      type: "object",
    },
    OutputCompareType: {
      enum: ["diff", "re_match", "sim_size", "re_match_multiline", "contains", "image_diff"],
    ...
    RegexParameterValidatorModel: {
      ...
      required: ["expression"],
      title: "RegexParameterValidatorModel",
      type: "object",
    },
    ResourceRequirement: {
      properties: {
        ...
        timelimit: {
          ...
          default: null,
          description:
            "Maximum time in seconds the tool is allowed to run. Job will be terminated if exceeded.",
          title: "Timelimit",
        },
        tmpdir_max: {
          anyOf: [
    ...
    ToolOutputBoolean: {
      ...
      required: ["name", "hidden", "type"],
      title: "ToolOutputBoolean",
      type: "object",
    },
    ToolOutputCollectionStructure: {
      properties: {
        ...
        collection_type_from_rules: {
          ...
          default: null,
          title: "Collection Type From Rules",
        },
      ...
      title: "ToolOutputCollectionStructure",
      type: "object",
    },
    ToolOutputFloat: {
      properties: {
    ...
    ToolProvidedMetadataDatasetCollection: {
      ...
      title: "ToolProvidedMetadataDatasetCollection",
      type: "object",
    },
    UserToolSource: {
      additionalProperties: false,
      properties: {
        ...
        configfiles: {
          anyOf: [
            {
              items: {
                $ref: "#/$defs/YamlTemplateConfigFile",
              },
              type: "array",
            },
            {
        ...
        description: {
          ...
          default: null,
          description:
            "The description is displayed in the tool menu immediately following the hyperlink for the tool.",
          title: "description",
        },
        edam_operations: {
          anyOf: [
        ...
        id: {
          ...
          default: null,
          description:
            "Unique identifier for the tool. Lowercase, must start with a letter, may contain letters, digits, '_' and '-'.",
        ...
        inputs: {
          default: [],
          items: {
            $ref: "#/$defs/YamlGalaxyToolParameter",
          },
          title: "inputs",
          type: "array",
        },
        license: {
          ...
          default: null,
          description:
            "A full URI or a a short [SPDX](https://spdx.org/licenses/) identifier for a license for this tool wrapper. The tool wrapper license can be independent of the underlying tool license. This license covers the tool yaml and associated scripts shipped with the tool.",
          examples: ["MIT"],
          title: "license",
        },
        name: {
          description:
            "The name of the tool, displayed in the tool menu. This is not the same as the tool id, which is a unique identifier for the tool.",
          minLength: 5,
          title: "name",
          type: "string",
        },
        outputs: {
          ...
          items: {
            discriminator: {
              mapping: {
                boolean: "#/$defs/ToolOutputBoolean",
                collection: "#/$defs/IncomingToolOutputCollection",
                data: "#/$defs/IncomingToolOutputDataset",
                float: "#/$defs/ToolOutputFloat",
                integer: "#/$defs/ToolOutputInteger",
                text: "#/$defs/ToolOutputText",
              },
              propertyName: "type",
            },
            oneOf: [
              {
                $ref: "#/$defs/IncomingToolOutputDataset",
              },
              {
                $ref: "#/$defs/IncomingToolOutputCollection",
              },
              {
                $ref: "#/$defs/ToolOutputText",
              },
              {
                $ref: "#/$defs/ToolOutputInteger",
              },
              {
                $ref: "#/$defs/ToolOutputFloat",
              },
              {
                $ref: "#/$defs/ToolOutputBoolean",
              },
            ],
          },
          title: "outputs",
        ...
        requirements: {
          anyOf: [
            {
              items: {
                anyOf: [
                  {
                    $ref: "#/$defs/JavascriptRequirement",
                  },
                  {
                    $ref: "#/$defs/ResourceRequirement",
                  },
                  {
                    $ref: "#/$defs/ContainerRequirement",
                  },
                ],
              },
              type: "array",
          ...
          default: [],
          description:
            "A list of requirements needed to execute this tool. These can be javascript expressions, resource requirements or container images.",
          title: "requirements",
        },
        shell_command: {
          description:
            "A string that contains the command to be executed. Parameters can be referenced inside $().",
      ...
      required: ["name", "shell_command", "class", "container"],
    ...
    YamlConditionalParameter: {
      ...
      properties: {
        ...
        test_parameter: {
          discriminator: {
            mapping: {
              boolean: "#/$defs/YamlBooleanParameter",
              select: "#/$defs/YamlSelectParameter",
            },
            propertyName: "type",
          },
          oneOf: [
            {
              $ref: "#/$defs/YamlBooleanParameter",
            },
            {
              $ref: "#/$defs/YamlSelectParameter",
            },
          ],
      ...
      required: ["name", "type", "test_parameter", "whens"],
      title: "YamlConditionalParameter",
      type: "object",
    },
    YamlConditionalWhen: {
      additionalProperties: false,
    ...
    YamlDataCollectionParameter: {
      ...
      required: ["name", "type"],
      title: "YamlDataCollectionParameter",
      type: "object",
    },
    YamlDataParameter: {
      additionalProperties: false,
    ...
    YamlFloatParameter: {
      ...
      properties: {
        ...
        validators: {
          default: [],
          items: {
            $ref: "#/$defs/InRangeParameterValidatorModel",
          },
          title: "Validators",
          type: "array",
        },
    ...
    YamlGalaxyToolParameter: {
      discriminator: {
        mapping: {
          boolean: "#/$defs/YamlBooleanParameter",
          color: "#/$defs/YamlColorParameter",
          conditional: "#/$defs/YamlConditionalParameter",
          data: "#/$defs/YamlDataParameter",
          data_collection: "#/$defs/YamlDataCollectionParameter",
          float: "#/$defs/YamlFloatParameter",
          integer: "#/$defs/YamlIntegerParameter",
          repeat: "#/$defs/YamlRepeatParameter",
          section: "#/$defs/YamlSectionParameter",
          select: "#/$defs/YamlSelectParameter",
          text: "#/$defs/YamlTextParameter",
        },
        propertyName: "type",
      },
      oneOf: [
        ...
        {
          $ref: "#/$defs/YamlIntegerParameter",
        },
        {
          $ref: "#/$defs/YamlFloatParameter",
        },
        {
          $ref: "#/$defs/YamlTextParameter",
        },
        {
          $ref: "#/$defs/YamlSelectParameter",
        },
        {
          $ref: "#/$defs/YamlColorParameter",
        },
        {
          $ref: "#/$defs/YamlDataParameter",
        },
        {
          $ref: "#/$defs/YamlDataCollectionParameter",
        },
        {
          $ref: "#/$defs/YamlConditionalParameter",
        },
        {
          $ref: "#/$defs/YamlRepeatParameter",
        },
        {
          $ref: "#/$defs/YamlSectionParameter",
        },
      ],
      title: "YamlGalaxyToolParameter",
    },
    ...
    YamlSelectParameter: {
      ...
      properties: {
        ...
        validators: {
          default: [],
          items: {
            $ref: "#/$defs/NoOptionsParameterValidatorModel",
          },
          title: "Validators",
          type: "array",
        },
    ...
    YamlTestCredential: {
      ...
      properties: {
        ...
        secrets: {
          ...
          items: {
            $ref: "#/$defs/YamlTestCredentialValue",
          },
          title: "Secrets",
          type: "array",
        },
      ...
      properties: {
        ...
        validators: {
          ...
          items: {
            anyOf: [
              {
                $ref: "#/$defs/LengthParameterValidatorModel",
              },
              {
                $ref: "#/$defs/RegexParameterValidatorModel",
              },
              {
                $ref: "#/$defs/EmptyFieldParameterValidatorModel",
              },
            ],
          },
          title: "Validators",
    ...
    YamlToolSource: {
      ...
      required: ["name", "shell_command", "class"],
      title: "YamlToolSource",
      type: "object",
    },
    YamlToolTest: {
      additionalProperties: false,
  ...
  discriminator: {
    mapping: {
      GalaxyTool: "#/$defs/YamlToolSource",
      GalaxyUserTool: "#/$defs/UserToolSource",
    },
    propertyName: "class",
  },
  oneOf: [
    {
      $ref: "#/$defs/UserToolSource",
    },
    {
      $ref: "#/$defs/YamlToolSource",
    },
  ],
} as const;
