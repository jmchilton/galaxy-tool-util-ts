...
unresolved.
 */
export interface DraftWorkflowStep extends WorkflowStep {
  /** The unique identifier for this object. */
  id?: null | string;
  /** A short, human-readable label of this object. */
  label?: null | string;
 ...
 */
export interface GalaxyWorkflowDraft extends Process, HasUUID {
  /** The unique identifier for this object. */
  id?: null | string;
  ...
  doc?: null | string | Array<string>;
  /** The individual steps that make up the workflow. Each step is executed when all of its input data links are fulfilled. */
  steps: Array<DraftWorkflowStep> | Record<string, DraftWorkflowStep>;
  /** Workflow invocation report template. */
  report?: null | Report;
  /** Tags for the workflow. */
  tags?: Array<string> | null;
