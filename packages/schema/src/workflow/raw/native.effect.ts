 ...
 */
export const PrimitiveTypeSchema = Schema.Literal("null", "boolean", "int", "long", "float", "double", "string")
 ...
 */
export const NativeStepTypeSchema = Schema.Literal("data_input", "data_collection_input", "parameter_input", "tool", "subworkflow", "pause", "pick_value")
...
export const RecordSchemaSchema = Schema.Struct({
  ...
  fields: Schema.optional(Schema.Union(Schema.Null, Schema.Array(Schema.suspend((): Schema.Schema<any> => RecordFieldSchema).annotations({ identifier: "RecordFieldSchema" })))),
  /** Must be `record` */
...
export const ArraySchemaSchema = Schema.Struct({
  ...
  items: Schema.Union(PrimitiveTypeSchema, RecordSchemaSchema, EnumSchemaSchema, Schema.suspend((): Schema.Schema<any> => ArraySchemaSchema).annotations({ identifier: "ArraySchemaSchema" }), Schema.String, Schema.Array(Schema.Union(PrimitiveTypeSchema, RecordSchemaSchema, EnumSchemaSchema, Schema.suspend((): Schema.Schema<any> => ArraySchemaSchema).annotations({ identifier: "ArraySchemaSchema" }), Schema.String))),
  /** Must be `array` */
...
export const RecordFieldSchema = Schema.Struct({
  ...
  name: Schema.String,
  /** The field type */
  type: Schema.Union(PrimitiveTypeSchema, RecordSchemaSchema, EnumSchemaSchema, ArraySchemaSchema, Schema.String, Schema.Array(Schema.Union(PrimitiveTypeSchema, RecordSchemaSchema, EnumSchemaSchema, ArraySchemaSchema, Schema.String))),
})
...
export const SampleSheetColumnDefinitionSchema = Schema.Struct({
  ...
  default_value: Schema.optional(Schema.Union(Schema.Null, Schema.String, Schema.Number, Schema.Boolean)),
  ...
  restrictions: Schema.optional(Schema.Union(Schema.Null, Schema.Array(Schema.Union(Schema.String, Schema.Number, Schema.Number, Schema.Boolean)))),
  /** Open suggestion list for this column. */
  suggestions: Schema.optional(Schema.Union(Schema.Null, Schema.Array(Schema.Union(Schema.String, Schema.Number, Schema.Number, Schema.Boolean)))),
})
...
export const RecordFieldDefinitionSchema = Schema.Struct({
  ...
  type: Schema.Union(Schema.Literal("File", "null", "boolean", "int", "float", "string"), Schema.Array(Schema.Literal("File", "null", "boolean", "int", "float", "string"))),
...
export const NativePostJobActionSchema = Schema.Struct({
  ...
  action_arguments: Schema.optional(Schema.Union(Schema.Record({ key: Schema.String, value: Schema.Unknown }), Schema.Null)),
})
...
export const NativeGalaxyWorkflowSchema = Schema.Struct({
  ...
  creator: Schema.optional(Schema.Union(Schema.Array(Schema.Union(NativeCreatorPersonSchema, NativeCreatorOrganizationSchema)), Schema.Null)),
  /** Workflow invocation report template. */
  ...
  comments: Schema.optional(Schema.Union(Schema.Array(Schema.Union(NativeTextCommentSchema, NativeMarkdownCommentSchema, NativeFrameCommentSchema, NativeFreehandCommentSchema)), Schema.Null)),
  ...
  steps: Schema.optional(Schema.Union(Schema.Record({ key: Schema.String, value: Schema.suspend((): Schema.Schema<any> => NativeStepSchema).annotations({ identifier: "NativeStepSchema" }) }), Schema.Null)),
  /** Map of locally-defined subworkflow dicts, used during format conversion. */
  subworkflows: Schema.optional(Schema.Union(Schema.Record({ key: Schema.String, value: Schema.suspend((): Schema.Schema<any> => NativeGalaxyWorkflowSchema).annotations({ identifier: "NativeGalaxyWorkflowSchema" }) }), Schema.Null)),
})
...
export const NativeStepSchema = Schema.Struct({
  ...
  tool_state: Schema.optional(Schema.Union(Schema.String, Schema.Record({ key: Schema.String, value: Schema.Unknown }), Schema.Null)),
  ...
  input_connections: Schema.optional(Schema.Union(Schema.Record({ key: Schema.String, value: Schema.Union(NativeInputConnectionSchema, Schema.Array(NativeInputConnectionSchema)) }), Schema.Null)),
  ...
  workflow_outputs: Schema.optional(Schema.Union(Schema.Null, Schema.Array(NativeWorkflowOutputSchema))),
  ...
  post_job_actions: Schema.optional(Schema.Union(Schema.Record({ key: Schema.String, value: NativePostJobActionSchema }), Schema.Null)),
  ...
  tool_representation: Schema.optional(Schema.Union(Schema.Record({ key: Schema.String, value: Schema.Unknown }), Schema.Null)),
  /** Default values for step inputs. Keys are parameter names, values are objects with a ``default`` key. */
  in: Schema.optional(Schema.Union(Schema.Record({ key: Schema.String, value: Schema.Unknown }), Schema.Null)),
})
