 ...
 */
export const GalaxyTypeSchema = Schema.Literal("null", "boolean", "int", "long", "float", "double", "string", "integer", "text", "File", "data", "collection")
...
export const WorkflowCollectionParameterSchema = Schema.Struct({
  ...
  column_definitions: Schema.optional(Schema.Union(Schema.Null, Schema.Array(SampleSheetColumnDefinitionSchema))),
...
export const WorkflowTextParameterSchema = Schema.Struct({
  ...
  restrictions: Schema.optional(Schema.Union(Schema.Null, Schema.Array(Schema.Union(Schema.String, WorkflowTextOptionSchema)))),
  /** Open suggestion list. Galaxy still treats the input as text but offers these as suggestions. */
  suggestions: Schema.optional(Schema.Union(Schema.Null, Schema.Array(Schema.Union(Schema.String, WorkflowTextOptionSchema)))),
...
export const ProcessSchema = Schema.Struct({
  ...
  inputs: Schema.Union(Schema.Array(Schema.Union(WorkflowDataParameterSchema, WorkflowCollectionParameterSchema, WorkflowIntegerParameterSchema, WorkflowFloatParameterSchema, WorkflowTextParameterSchema, WorkflowBooleanParameterSchema)), Schema.Record({ key: Schema.String, value: Schema.Union(WorkflowDataParameterSchema, WorkflowCollectionParameterSchema, WorkflowIntegerParameterSchema, WorkflowFloatParameterSchema, WorkflowTextParameterSchema, WorkflowBooleanParameterSchema, Schema.String) }), Schema.Record({ key: Schema.String, value: Schema.Unknown })),
  /** Defines the parameters representing the output of the process.  May be used to generate and/or validate the output object. */
  outputs: Schema.Union(Schema.Array(WorkflowOutputParameterSchema), Schema.Record({ key: Schema.String, value: Schema.Union(WorkflowOutputParameterSchema, Schema.String) }), Schema.Record({ key: Schema.String, value: Schema.Unknown })),
})
...
export const WorkflowInputParameterSchema = Schema.Struct({
  ...
  optional: Schema.optional(Schema.Union(Schema.Boolean, Schema.Null)),
  /** Specify valid types of data that may be assigned to this parameter. */
  type: Schema.optional(Schema.Union(GalaxyTypeSchema, Schema.Null, Schema.Array(GalaxyTypeSchema))),
  /** Collection type (defaults to `list` if `type` is `collection`). Nested collection types are separated with colons, e.g. `list:list:paired`. */
  collection_type: Schema.optional(Schema.Union(Schema.Null, Schema.String)),
...
export const FrameCommentSchema = Schema.Struct({
  ...
  contains_steps: Schema.optional(Schema.Union(Schema.Null, Schema.Array(Schema.Union(Schema.String, Schema.Number)))),
  /** Comment labels or indices contained within this frame. */
  contains_comments: Schema.optional(Schema.Union(Schema.Null, Schema.Array(Schema.Union(Schema.String, Schema.Number)))),
})
...
export const GalaxyWorkflowSchema = Schema.Struct({
  ...
  steps: Schema.Union(Schema.Array(Schema.suspend((): Schema.Schema<any> => WorkflowStepSchema).annotations({ identifier: "WorkflowStepSchema" })), Schema.Record({ key: Schema.String, value: Schema.suspend((): Schema.Schema<any> => WorkflowStepSchema).annotations({ identifier: "WorkflowStepSchema" }) })),
  ...
  comments: Schema.optional(Schema.Union(Schema.Array(Schema.Union(TextCommentSchema, MarkdownCommentSchema, FrameCommentSchema, FreehandCommentSchema)), Schema.Record({ key: Schema.String, value: Schema.Union(TextCommentSchema, MarkdownCommentSchema, FrameCommentSchema, FreehandCommentSchema) }), Schema.Null)),
  ...
  creator: Schema.optional(Schema.Union(Schema.Array(Schema.Union(CreatorPersonSchema, CreatorOrganizationSchema)), Schema.Null)),
...
export const WorkflowStepOutputSchema = Schema.Struct({
  ...
  set_columns: Schema.optional(Schema.Union(Schema.Record({ key: Schema.String, value: Schema.Unknown }), Schema.Null)),
})
...
export const WorkflowStepSchema = Schema.Struct({
  ...
  in: Schema.optional(Schema.Union(Schema.Array(WorkflowStepInputSchema), Schema.Record({ key: Schema.String, value: Schema.Union(WorkflowStepInputSchema, Schema.String, Schema.Array(Schema.String)) }), Schema.Null)),
  ...
  out: Schema.optional(Schema.Union(Schema.Array(Schema.Union(WorkflowStepOutputSchema, Schema.String)), Schema.Record({ key: Schema.String, value: Schema.Union(WorkflowStepOutputSchema, Schema.String) }), Schema.Null)),
  /** Structured tool state. */
  state: Schema.optional(Schema.Union(Schema.Record({ key: Schema.String, value: Schema.Unknown }), Schema.Null)),
  ...
  post_job_actions: Schema.optional(Schema.Union(Schema.Record({ key: Schema.String, value: Schema.Unknown }), Schema.Null)),
  ...
  run: Schema.optional(Schema.Union(GalaxyWorkflowSchema, Schema.String, Schema.Record({ key: Schema.String, value: Schema.Unknown }), Schema.Null)),
