...
export const ProcessSchema = Schema.Struct({
  ...
  inputs: Schema.Union(Schema.Array(WorkflowInputParameterSchema), Schema.Record({ key: Schema.String, value: Schema.Union(WorkflowInputParameterSchema, Schema.String) }), Schema.Record({ key: Schema.String, value: Schema.Unknown })),
...
export const GalaxyWorkflowSchema = Schema.Struct({
  ...
  steps: Schema.Union(Schema.Array(Schema.suspend((): Schema.Schema<any> => WorkflowStepSchema)), Schema.Record({ key: Schema.String, value: Schema.suspend((): Schema.Schema<any> => WorkflowStepSchema) })),
...
export const WorkflowStepSchema = Schema.Struct({
  ...
  in: Schema.optional(Schema.Union(Schema.Array(WorkflowStepInputSchema), Schema.Record({ key: Schema.String, value: Schema.Union(WorkflowStepInputSchema, Schema.String) }), Schema.Null)),
