...
export const RecordSchemaSchema = Schema.Struct({
  ...
  fields: Schema.optional(Schema.Union(Schema.Null, Schema.Array(Schema.suspend((): Schema.Schema<any> => RecordFieldSchema)))),
  /** Must be `record` */
...
export const ArraySchemaSchema = Schema.Struct({
  ...
  items: Schema.Union(PrimitiveTypeSchema, RecordSchemaSchema, EnumSchemaSchema, Schema.suspend((): Schema.Schema<any> => ArraySchemaSchema), Schema.String, Schema.Array(Schema.Union(PrimitiveTypeSchema, RecordSchemaSchema, EnumSchemaSchema, Schema.suspend((): Schema.Schema<any> => ArraySchemaSchema), Schema.String))),
  /** Must be `array` */
...
export const NativeGalaxyWorkflowSchema = Schema.Struct({
  ...
  steps: Schema.optional(Schema.Union(Schema.Record({ key: Schema.String, value: Schema.suspend((): Schema.Schema<any> => NativeStepSchema) }), Schema.Null)),
  /** Map of locally-defined subworkflow dicts, used during format conversion. */
  subworkflows: Schema.optional(Schema.Union(Schema.Record({ key: Schema.String, value: Schema.suspend((): Schema.Schema<any> => NativeGalaxyWorkflowSchema) }), Schema.Null)),
})
